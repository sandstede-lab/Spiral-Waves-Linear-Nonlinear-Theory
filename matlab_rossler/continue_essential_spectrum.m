...
%% Repeat for ess_zero, zero_pd, weight_pd_w0p1, weight_zero_w0p1
file_names.wt = 'data/Rossler_start_ess_zero.mat';
file_names.out_name = 'spectrum_rossler_ess_c2_zero.txt';
...
% continuation!
contPar.ds   = 0.02*1i;                % continuation step size: sign determines direction - should be imaginary since nu = i*gamma is treated as a complex number
contPar.Name = 'nu';
contPar.free = 'lambda';
contPar.numContSteps = 100;     % Number of continuation steps (in each direction)
