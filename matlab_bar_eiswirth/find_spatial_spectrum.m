%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Finds starting data for absolute spectrum using spatial spectrum
...
file_names.starting_point = 'data/Bar_Eiswirth_wave_train_nx256.mat';
file_names.out_name = 'Bar_Eiswirth_spatial_spectrum_nx256.mat';
